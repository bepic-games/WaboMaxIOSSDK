...
#ifndef WABOMAX_SWIFT_H
#define WABOMAX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboMax",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface WaboMax : NSObject
+ (WaboMax * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
...
- (WaboBridgeResult * _Nonnull)isRewardedAdReady:(NSString * _Nullable)placementId SWIFT_WARN_UNUSED_RESULT;
...
- (void)setWaboMaxInterstitialAdDelegate:(void (^ _Nonnull)(id _Nullable))delegate;
- (void)setWaboMaxBannerAdDelegate:(void (^ _Nonnull)(id _Nullable))delegate;
...
SWIFT_CLASS("_TtC7WaboMax25WaboMaxAppopenAdvertising")
@interface WaboMaxAppopenAdvertising : NSObject <MAAdDelegate>
...
SWIFT_CLASS("_TtC7WaboMax24WaboMaxBannerAdvertising")
@interface WaboMaxBannerAdvertising : NSObject <MAAdViewAdDelegate>
...
SWIFT_CLASS("_TtC7WaboMax30WaboMaxInterstitialAdvertising")
@interface WaboMaxInterstitialAdvertising : NSObject <MAAdDelegate>
- (void)didLoadAd:(MAAd * _Nonnull)ad;
- (void)didFailToLoadAdForAdUnitIdentifier:(NSString * _Nonnull)adUnitIdentifier withError:(MAError * _Nonnull)error;
- (void)didDisplayAd:(MAAd * _Nonnull)ad;
- (void)didHideAd:(MAAd * _Nonnull)ad;
...
SWIFT_CLASS("_TtC7WaboMax26WaboMaxRewardedAdvertising")
@interface WaboMaxRewardedAdvertising : NSObject <MARewardedAdDelegate>
